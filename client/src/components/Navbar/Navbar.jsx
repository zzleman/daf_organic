  ...
  return (
    <div className='navbar flex gap-10 justify-between my-2 lg:my-8 mx-4 lg:mx-16'>
      <div className="left flex gap-4">
        <img className='h-12 mt-7 lg:hidden' src="icons/menu_icon.png" alt="" />
        <img className='h-24 w-24' src ="img/daf_logo.png" alt="" />
      </div>
      ...
      <div className="right flex gap-7 mt-7">
        <div className='searching flex relative'>
          ...
          <img className='icons absolute right-0' id='search-icon' src="icons/search_icon.png" alt="" />
        </div>
